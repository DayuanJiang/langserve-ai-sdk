...
const Tabs = () => {
  ...
  const tabData = [
    { 
      title: "アニメ生成",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mr-2 fill-current" viewBox="0 0 24 24">
    ...
    { 
      title: "グラフ",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mr-1 fill-current" viewBox="0 0 24 24">
